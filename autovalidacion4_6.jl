...
println("------------------")
println("Test streamLearning_SVM pasados")
println("------------------")
...
println("------------------")
println("Test streamLearning_ISVM pasados")
println("------------------")
...
println("------------------")
println("Test euclideanDistances pasados")
println("------------------")
...
println("------------------")
println("Test nearestElements pasados")
println("------------------")
...
println("------------------")
println("Test predictKNN pasados")
println("------------------")
...
println("------------------")
println("Test streamLearning_KNN pasados")
println("------------------")
...
println("------------------")
println("Test predictKNN_SVM pasados")
println("------------------")